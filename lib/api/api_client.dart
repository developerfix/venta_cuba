...
class ApiClient extends GetxService {
  ...
  Future<Response> postData(String uri, dynamic body,
    ...
    try {
      ...
      // DISABLED: Old emergency fix that redirected to user's own listings
      // Now we intentionally fetch ALL posts with empty lat/lng and filter client-side
      /*
      if (uri.contains("getListing") && body != null && body is Map) {
        ...
        if ((lat == null || lat.isEmpty) && (lng == null || lng.isEmpty) && userId != null && userId.isNotEmpty) {
          ...
          // ... rest of emergency fix code removed ...
        }
      }
      */
